namespace UglyToad.PdfPig.Util
{
    ...
    /// </summary>
    public class DefaultWordExtractor_v2 : IWordExtractor
    {
        /// <summary>
        /// Gets the words.
        /// </summary>
        ...
        public IEnumerable<Word> GetWords(IReadOnlyList<Letter> letters)
        {
            ...
            foreach (var letter in lettersOrder)
            {
                ...
                //If gap == 0 do we need to do all this computation?
        ...
        /// </summary>
        public static IWordExtractor Instance { get; } = new DefaultWordExtractor_v2();

        private DefaultWordExtractor_v2()
        {
        }
    }
}