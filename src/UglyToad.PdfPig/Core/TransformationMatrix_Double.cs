namespace UglyToad.PdfPig.Core
{
    ...
    /// </summary>
    public struct TransformationMatrix_Double
    {
        /// <summary>
        /// The default <see cref="TransformationMatrix_Double"/>.
        /// </summary>
        public static TransformationMatrix_Double Identity = new TransformationMatrix_Double(new double[]
        {
            1,0,0,
            0,1,0,
            0,0,1
        ...
        /// <summary>
        /// Create a new <see cref="TransformationMatrix_Double"/>.
        /// </summary>
        /// <param name="value">The 9 values of the matrix.</param>
        public TransformationMatrix_Double(double[] value)
        {
            if (value == null)
            {
        ...
        [Pure]
        public PdfPoint_Double Transform(PdfPoint_Double original)
        {
            var x = A * original.X + C * original.Y + E;
            var y = B * original.X + D * original.Y + F;

            return new PdfPoint_Double(x, y);
        }
        ...
        /// <summary>
        /// Create a new <see cref="TransformationMatrix_Double"/> from the 6 values provided in the default PDF order.
        /// </summary>
        public static TransformationMatrix_Double FromValues(double a, double b, double c, double d, double e, double f)
            => FromArray(new[] {a, b, c, d, e, f});

        /// <summary>
        /// Create a new <see cref="TransformationMatrix_Double"/> from the values.
        /// </summary>
        ...
        /// <returns></returns>
        public static TransformationMatrix_Double FromArray(double[] values)
        {
            if (values.Length == 9)
            {
                return new TransformationMatrix_Double(values);
            }

            if (values.Length == 6)
            {
                return new TransformationMatrix_Double(new []
                {
                    values[0], values[1], 0,
                    values[2], values[3], 0,
                    values[4], values[5], 1
        ...
        [Pure]
        public TransformationMatrix_Double Multiply(TransformationMatrix_Double matrix)
        {
            ...
            return new TransformationMatrix_Double(result);
        }
        ...
        //[Pure]
        //public TransformationMatrix_Double Multiply(decimal scalar)
        //{
        ...
        //{
        //    if (!(obj is TransformationMatrix_Double m))
        //    {
        //        return false;
        //    }
        ...
        ///// </summary>
        //public static bool Equals(TransformationMatrix_Double a, TransformationMatrix_Double b)
        //{
        //    for (var i = 0; i < Rows; i++)
        //    {
        //        for (var j = 0; j < Columns; j++)
        ...
        ///// <summary>
        ///// Create a new <see cref="TransformationMatrix_Double"/> with the X and Y translation values set.
        ///// </summary>
        //public static TransformationMatrix_Double GetTranslationMatrix(decimal x, decimal y)
        //{
        //    return new TransformationMatrix_Double(new []
        //    {
        //        1, 0, 0,
