namespace UglyToad.PdfPig.Geometry
{
    ...
    /// </remarks>
    public struct PdfPoint_Double
    {
        /// <summary>
        /// The origin of the coordinates system.
        /// </summary>
        public static PdfPoint_Double Origin { get; } = new PdfPoint_Double(0m, 0m);
        ...
        /// </summary>
        [DebuggerStepThrough]
        public PdfPoint_Double(decimal x, decimal y)
        {
            X = (double)x;
            Y = (double)y;
        }
        ...
        /// </summary>
        [DebuggerStepThrough]
        public PdfPoint_Double(int x, int y)
        {
            X = x;
            Y = y;
        }
        ...
        /// </summary>
        [DebuggerStepThrough]
        public PdfPoint_Double(double x, double y)
        {
            X = x;
            Y = y;
        }
        ...
        public PdfPoint_Double MoveX(double dx)
        {
            return new PdfPoint_Double(X + dx, Y);
        }
        ...
        public PdfPoint_Double MoveY(double dy)
        {
            return new PdfPoint_Double(X, Y + dy);
        }
